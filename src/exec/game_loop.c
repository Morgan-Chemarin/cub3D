...
/*   Updated: 2025/11/18 19:17:24 by dev              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void draw_test_pattern(t_data *data)
{
	...
	while (x < data->screen_w)
	{
		...
		// un truc chelou de distorsion et doeil de poisson
		// calculer la longueur du mur a dessiner
		x++;
	}
}
...
int	game_loop(t_data *data)
{
	if (!data->running)
		return (0);
	// afficher plafond et sol avant mur
